...
class Menu(BaseModel):
    ...
    parentId = Column("parent_id", db.String, db.ForeignKey('menu.id'), comment="父ID")
    ...
    path = Column("path", db.String, nullable=False, comment="菜单路径")
    icon = Column("icon", db.String, comment="菜单图标")
